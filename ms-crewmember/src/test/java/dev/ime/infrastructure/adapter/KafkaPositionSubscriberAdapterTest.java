...
class KafkaPositionSubscriberAdapterTest {
	...
	@InjectMocks
	private KafkaPositionSubscriberAdapter kafkaPositionSubscriberAdapter;	
	...
	@Test
	void onMessage_WithConsumerRecord_ProcessOk() {
		...
		StepVerifier
		.create(kafkaPositionSubscriberAdapter.onMessage(consumerRecord))
		.verifyComplete();
