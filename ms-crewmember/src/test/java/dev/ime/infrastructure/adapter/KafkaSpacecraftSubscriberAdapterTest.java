...
class KafkaSpacecraftSubscriberAdapterTest {
	...
	@InjectMocks
	private KafkaSpacecraftSubscriberAdapter kafkaSpacecraftSubscriberAdapter;
	...
	@Test
	void onMessage_WithConsumerRecord_ProccessCompleted() {
		...
		StepVerifier
		.create(kafkaSpacecraftSubscriberAdapter.onMessage(consumerRecord))
		.verifyComplete();
