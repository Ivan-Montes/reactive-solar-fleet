...
public class KafkaPositionSubscriberAdapter implements SubscriberPort{
	...
	public KafkaPositionSubscriberAdapter(LoggerUtil loggerUtil, @Qualifier("positionRedisProjectorAdapter")BaseProjectorPort baseProjectorPort) {
		super();
	...
	@Override
	@KafkaListener(topics = {GlobalConstants.POSITION_CREATED, GlobalConstants.POSITION_DELETED}, groupId = "mscrewmember-consumer-position")
	...
	private Mono<?> processEvent(ConsumerRecord<String, Event> consumer){
