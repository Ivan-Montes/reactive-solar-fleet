...
public class KafkaCrewMemberSubscriberAdapter implements SubscriberPort{
	...
	public KafkaCrewMemberSubscriberAdapter(LoggerUtil loggerUtil, @Qualifier("crewMemberProjectorAdapter")BaseProjectorPort baseProjectorPort,
			@Qualifier("crewMemberProjectorAdapter")ExtendedProjectorPort extendedProjectorPort) {
		super();
	...
	private Map<String, Function<Event, Mono<?>>> initializeActionsMap() {
		...
		return Map.of(
                ...
                GlobalConstants.CREWMEMBER_UPDATED, extendedProjectorPort::update,
	...
	@Override
	@KafkaListener(topics = {GlobalConstants.CREWMEMBER_CREATED, GlobalConstants.CREWMEMBER_UPDATED, GlobalConstants.CREWMEMBER_DELETED}, groupId = "mscrewmember-consumer-crewmember")
