...
class QueryDispatcherTest {
	...
	void getQueryHandler_ByDefault_ReturnQueryHandler() {
		...
		GetAllShipclassQuery getAllQuery = new GetAllShipclassQuery(PageRequest.of(0, 22));
		
		QueryHandler<Flux<Shipclass>> handler = queryDispatcher.getQueryHandler(getAllQuery);
