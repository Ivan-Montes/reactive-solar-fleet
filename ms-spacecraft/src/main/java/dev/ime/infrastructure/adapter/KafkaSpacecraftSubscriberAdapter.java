...
public class KafkaSpacecraftSubscriberAdapter  implements SubscriberPort{
    ...
    public KafkaSpacecraftSubscriberAdapter(LoggerUtil loggerUtil, @Qualifier("spacecraftProjectorAdapter")BaseProjectorPort baseProjectorPort,
    		@Qualifier("spacecraftProjectorAdapter")ExtendedProjectorPort extendedProjectorPort) {
		super();
	...
	private Map<String, Function<Event, Mono<?>>> initializeActionsMap() {
		...
		return Map.of(
                ...
                GlobalConstants.SPACECRAFT_UPDATED, extendedProjectorPort::update,
    ...
    @Override
	@KafkaListener(topics = {GlobalConstants.SPACECRAFT_CREATED, GlobalConstants.SPACECRAFT_UPDATED, GlobalConstants.SPACECRAFT_DELETED}, groupId = "msspacecraft-consumer-spacecraft")
