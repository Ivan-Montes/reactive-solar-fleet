...
public class KafkaCrewMemberSubscriberAdapter implements SubscriberPort{
    ...
    @Override
	@KafkaListener(topics = {GlobalConstants.CREWMEMBER_CREATED, GlobalConstants.CREWMEMBER_UPDATED, GlobalConstants.CREWMEMBER_DELETED}, groupId = "msspacecraft-consumer-crewmember")
