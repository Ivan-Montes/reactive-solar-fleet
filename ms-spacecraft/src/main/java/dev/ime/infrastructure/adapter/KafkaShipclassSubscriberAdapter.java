...
public class KafkaShipclassSubscriberAdapter implements SubscriberPort{
	...
	public KafkaShipclassSubscriberAdapter(LoggerUtil loggerUtil, @Qualifier("shipclassRedisProjectorAdapter")BaseProjectorPort baseProjectorPort) {
		super();
	...
	@Override	
	@KafkaListener(topics = {GlobalConstants.SHIPCLASS_CREATED, GlobalConstants.SHIPCLASS_DELETED}, groupId = "msspacecraft-consumer-shipclass")
